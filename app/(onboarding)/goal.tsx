...
const GOAL_OPTIONS: GoalOption[] = [
  {
    ...
    emoji: "🔥",
    emojiKey: "",
    labelKey: "onboarding.goal.loseWeight",
    subKey: "onboarding.goal.loseWeightSub",
  },
  {
    value: "gain_muscle",
    emoji: "💪",
    emojiKey: "",
    labelKey: "onboarding.goal.gainMuscle",
    subKey: "onboarding.goal.gainMuscleSub",
  },
  {
    value: "maintain",
    emoji: "⚖️",
    ...
    subKey: "onboarding.goal.maintainSub",
  },
  {
    value: "recomposition",
    emoji: "🔄",
    emojiKey: "",
    labelKey: "onboarding.goal.recomposition",
    subKey: "onboarding.goal.recompositionSub",
  },
];
